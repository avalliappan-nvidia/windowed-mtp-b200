...
def _decode_grouped_att_m_fwd(
    ...
    extra_kargs = {}
    # [RK experiment] grouped draft-decode split-K stage1 pipeline depth. Default 2
    # (upstream); RK_DECODE_STAGES lets us probe whether >2 buys back the ~97us TRI
    # draft-decode step vs FlashInfer's ~14us.
    import os as _os
    num_stages = int(_os.environ.get("RK_DECODE_STAGES") or "2")
    if _is_hip:
